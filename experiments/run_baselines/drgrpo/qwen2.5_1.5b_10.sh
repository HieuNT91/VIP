...
exp_name='Baseline_4epochs-Qwen2.5-1.5B-it-drgrpo_10'
...
AIME_2025=${AIME_2025:-"${RAY_DATA_HOME}/data/vip-aime-2025.parquet"}
AMC=${AMC:-"${RAY_DATA_HOME}/data/vip-amc.parquet"}
...
ray job submit --runtime-env="${RUNTIME_ENV}" \
    ...
    trainer.total_training_steps=67 \
