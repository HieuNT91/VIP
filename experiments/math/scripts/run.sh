...
TOTAL_EPOCHS=8 GPU_UTIL=0.8 LEARNING_RATE=1e-6 BATCH_BUDGET=4096 BATCH_SIZE=768 ADVANTAGE_ESTIMATOR=rloo BASE_MODEL=Qwen2.5-Math-7B ROLLOUT_SIZE=8 NGPUS=8 SEED=1 bash experiments/math/scripts/run_vip.sh
TOTAL_EPOCHS=8 GPU_UTIL=0.8 LEARNING_RATE=2e-6 BATCH_BUDGET=4096 BATCH_SIZE=768 ADVANTAGE_ESTIMATOR=rloo BASE_MODEL=Qwen2.5-Math-7B ROLLOUT_SIZE=8 NGPUS=8 SEED=1 bash experiments/math/scripts/run_vip.sh
TOTAL_EPOCHS=8 GPU_UTIL=0.8 LEARNING_RATE=3e-6 BATCH_BUDGET=4096 BATCH_SIZE=768 ADVANTAGE_ESTIMATOR=rloo BASE_MODEL=Qwen2.5-Math-7B ROLLOUT_SIZE=8 NGPUS=8 SEED=1 bash experiments/math/scripts/run_vip.sh
TOTAL_EPOCHS=8 GPU_UTIL=0.8 LEARNING_RATE=4e-6 BATCH_BUDGET=4096 BATCH_SIZE=768 ADVANTAGE_ESTIMATOR=rloo BASE_MODEL=Qwen2.5-Math-7B ROLLOUT_SIZE=8 NGPUS=8 SEED=1 bash experiments/math/scripts/run_vip.sh
