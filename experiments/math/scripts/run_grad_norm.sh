...
response_length_multiple=${RESPONSE_LENGTH_MULTIPLE:-6}
...
train_prompt_mini_bsz=1 # set this equal to train_prompt_bsz to enable on_policy
...
python3 -m train.dapo.main_calc_grad_norm \
    ...
    actor_rollout_ref.actor.optim.lr_warmup_steps=10000 \
